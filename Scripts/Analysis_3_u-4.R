...
#### This script generates matrices with meanlog = -4. See other script for -2.
...
av_matrices <- c()
for(i in 1:length(av_n_subsets)){
	av_matrices[[i]] <- lapply(av_sub_trees[[i]], sim.morpho, characters=av_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
	print(i)
	}
...
pdf(file="Analysis3_meanlog-4_Avialae_2024-02-20.pdf")
...
neo_matrices <- c()
for(i in 1:length(neo_n_subsets)){
	neo_matrices[[i]] <- lapply(neo_sub_trees[[i]], sim.morpho, characters=neo_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
	print(i)
	}
...
pdf(file="Analysis3_meanlog-4_Neornithes_2024-02-20.pdf")
...
pas_matrices <- c()
for(i in 1:length(pas_n_subsets)){
	pas_matrices[[i]] <- lapply(pas_sub_trees[[i]], sim.morpho, characters=pas_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
	print(i)
	}
...
pdf(file="Analysis3_meanlog-4_Passeriformes_2024-02-20.pdf")
...
tel_matrices <- c()
for(i in 1:length(tel_n_subsets)){
	tel_matrices[[i]] <- lapply(tel_sub_trees[[i]], sim.morpho, characters=tel_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
	print(i)
	}
...
pdf(file="Analysis3_meanlog-4_Telluraves_2024-02-20.pdf")
