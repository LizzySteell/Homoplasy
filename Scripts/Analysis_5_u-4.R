...
### This script is for rate category: -4
...
av_matrix <- sim.morpho(av_tree, characters=av_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
...
pdf("Analysis5_meanlog-4_Avialae.pdf")
...
neo_matrix <- sim.morpho(neo_tree, characters=neo_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
...
pdf("Analysis5_meanlog-4_Neornithes.pdf")
...
pas_matrix <- sim.morpho(pas_tree, characters=pas_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
...
pdf("Analysis5_meanlog-4_Passeriformes.pdf")
...
tel_matrix <- sim.morpho(tel_tree, characters=tel_char, states=c(0.9, 0.1), model="ER", rates=c(rlnorm, meanlog=-4, sdlog=0.1), invariant=FALSE)
...
pdf("Analysis5_meanlog-4_Telluraves.pdf")
